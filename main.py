...
answer = input("What do you go to first? 1. The file cabinet. 2. The computer. 3. The furniture. 4. The bookcase. Type your number now.")
if answer == "1":
    print("You open the file cabinet but there's nothing inside")
answer = input(" Where else would you like to go? 2. The computer. 3. The furniture. 4. The bookcase. Type your number now.")
if answer == "2":
    print("You walk over to the computer and sit down. There is a piece of paper on the table that says 'You have three tasks',")
    ...
    print("You open up the IDE and write the programs.")
if answer == "3":
    print("You search the furniture but you don't find any clues or a key.")
    answer = input(" Where else would you like to go? 1. The file cabinent 2. The computer. 4. The bookcase. Type your number now.")
    if answer == "2":
        print("You walk over to the computer and sit down. There is a piece of paper on the table that says 'You have three tasks',")
        print("Write a program that tells what 28 days from today would be, then link to a weather forecast site for the day in question, a")
        print(" link to the weather forecast site for a week later. Write a problem that pulls air quailty reports for the day of.")
    ...
    if answer == "4":
        ...
        answer = input(" Where else would you like to go? 1. The file cabinent 2. The computer. Type your number now.")
        if answer == "2":
                print("You walk over to the computer and sit down. There is a piece of paper on the table that says 'You have four tasks',")
                print("Write a program that tells what 28 days from today would be, then link to a weather forecast site for the day in question, a")
                print(" link to the weather forecast site for a week later. Write a problem that pulls air quailty reports for the day of. Write a ")
                print(" loop that ends at 5. ")
                print("The computer is already on with just three visible icons on the desktop. A browser, an IDE, and the symbol for settings. ")
                print("You open up the IDE and write the programs.")
    #Module #1.
        import datetime
